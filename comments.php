...
<div id="comments">
	...
	<?php if ( have_comments() ) : ?>
		<h2 id="comments-title">
			<?php
				...
				if ( '1' === $comments_number ) {
					...
					printf( _x( 'One Reply to &ldquo;%s&rdquo;', 'comments title', 'startup' ), get_the_title() );
				} else {
					printf(
		...
		<nav id="comment-nav-above">
			<h1 class="assistive-text"><?php _e( 'Comment navigation', 'startup' ); ?></h1>
		...
		<ol class="commentlist">
			<?php
				 ...
				 */
				wp_list_comments( array( 'callback' => 'startup_comment' ) );
			?>
		</ol>
	...
	?>
		<h2 id="comments-title" class="nocomments"><?php _e( 'Comments are closed.', 'startup' ); ?></h2>
