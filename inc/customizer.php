...
function startup_customize( $wp_customize ) {
 ...
 */
	...
	$wp_customize->add_control( new WP_Customize_Image_Control($wp_customize, 'header_logo', array(
		'label'       => __( 'Upload Header Logo', 'startup' ),
		'description' => __( 'Height: &gt;80px', 'startup' ),
	...
	$wp_customize->add_control( 'navbar_scheme', array(
		'type'          => 'radio',
		'label'         => __( 'Navbar Scheme', 'startup' ),
		'section'       => 'theme_header_section',
		'choices' => array(
			'navbar-light bg-light'   => __( 'Default', 'startup' ),
			'navbar-dark bg-dark'   => __( 'Dark', 'startup' ),
			'navbar-dark bg-primary'   => __( 'Primary', 'startup' ),
		),
	...
	$wp_customize->add_control( 'navbar_position', array(
		'type'          => 'radio',
		'label'         => __( 'Navbar', 'startup' ),
		'section'       => 'theme_header_section',
		'choices' => array(
			'static'       => __( 'Static', 'startup' ),
			'fixed_top'    => __( 'Fixed to top', 'startup' ),
			'fixed_bottom' => __( 'Fixed to bottom', 'startup' ),
		),
	...
	$wp_customize->add_control( 'search_enabled', array(
		'type'          => 'checkbox',
		'label'         => __( 'Show Searchfield?', 'startup' ),
		'section'       => 'theme_header_section',
...
add_action( 'customize_register', 'startup_customize' );
