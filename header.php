				...
				<div id="navbar" class="collapse navbar-collapse">
					...
					<?php if ( isset( $search_enabled ) && '1' === $search_enabled ) : ?>
						<form class="form-inline search-form my-2 my-lg-0" role="search" method="get" action="<?php echo esc_url( home_url( '/' ) ); ?>">
							<input type="text" id="s" name="s" class="form-control mr-sm-2" placeholder="<?php _e( 'Search', 'startup' ); ?>...">
							<button type="submit" id="searchsubmit" name="submit" class="btn btn-outline-secondary my-2 my-sm-0"><?php _e( 'Search', 'startup' ); ?></button>
						</form>
					<?php endif; ?>
				</div><!-- /.navbar-collapse -->
			</div><!-- /.container -->
